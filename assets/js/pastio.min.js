...
(function(){
    var Pastio = {
        ...
        initialize_editor: function(){
            ...
            $('#pastio-syntax').on('click', function(e){
                e.preventDefault();
                var el = $(this);
                var mode_list = '';
                var data = instance.get_modes();
                $.each(data.modes, function(key, value){
                    mode_list += '<li><span class="set-pastio-mode" data-mode="'+value+'">'+value+'</span></li>';
                });
                el.unbind('click').popover({
                    ...
                    trigger: 'click',
                    container: 'body',
                    content: '<ul class="pastio-syntax-list">'+mode_list+'</ul>'
                }).popover('show');
            });
            ...
            $(document).delegate('.set-pastio-mode', 'click', function(e){
                ...
                instance.set_editor_mode(new_mode);
