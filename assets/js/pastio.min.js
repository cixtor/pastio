...
jQuery(document).ready(function ($) {
    ...
    Pastio.prototype.bindSaveAction = function (element) {
        ...
        $(element).on('click', function (event) {
            ...
            $.post('/save', dataJson, function (data) {
                ...
                var url = instance.genContentUrl(data);
                var anchor = '<a href="' + url + '">' + url + '</a>';

                $('#pastio-modal .modal-header .modal-title').html(data.message);
                $('#pastio-modal .modal-body').html(data.message + anchor);
    ...
    Pastio.prototype.genContentUrl = function (data) {
